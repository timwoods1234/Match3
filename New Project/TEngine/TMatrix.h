...
public:
	...
	inline void TransformVector(TVector3* pVector) const;
	__forceinline void TransformVector(const TVector3* pInVector, TVector3* pOutVector) const;
	inline void RotateVector(TVector3* pVector) const;
	inline void RotateVector(const TVector3* pInVector, TVector3* pOutVector) const;
...
// TODO: inverse functions without d3dx
